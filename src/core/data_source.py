...
""" 
                 Notice
 num_entries(self): not implement
 short_name(self): not implement
 entry_generator(self, yield_just_one=False): not implement
 preprocess_entry(self, entry):  not implement
...
class BaseDataSource(object):
    ...
    def __init__(self,
        ...
        self._coordinator = tf.train.Coordinator()            #Create a thread manager
        self.all_threads = []
