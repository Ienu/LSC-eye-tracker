...
"""v0.0[insfan][5/25/2019] "Utility methods for generating only iris gazemaps"""
import cv2 as cv
import numpy as np
...
def from_gaze2d(gaze, output_size, scale=1.0):
    ...
    iris_radius = eyeball_radius_to_iris_diameter_ratio * eyeball_radius  # may be a error, iris_diameter
