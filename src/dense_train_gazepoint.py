...
"""v0.0[insfan][5/25/2019] Main script for training the Densenet model for within-MPIIGaze evaluationst"""
import argparse
            ...
            model = Densenet(
                ...
                train_data={
                    'mpi': NPZSource(
                        ...
                        npz_path='../datasets/MPIIFaceGaze_eyes_p00_50.npz',
                        eye_image_shape=(150, 150),
                        testing=False,
